...
class EventDetailedPage extends Component {
  ...
  async componentDidMount() {
    ...
    if (!event.exists) {
      toastr.error('Not found', 'This is not the events');
  ...
  render() {
    const { requesting, openModal, loading, event, auth, goingToEvent, cancelGoingToEvent, addEventComment, eventChat, match } = this.props;
